...
export class SecurityControllerService implements SecurityControllerServiceInterface {
    ...
    public login(jwtAuthRequest: JwtAuthRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<JwtAuthResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: jwtAuthRequest,
                responseType: <any>responseType_,
