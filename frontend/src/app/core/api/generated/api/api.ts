...
export const APIS = [BreakdownService, BreakdownTypesService, DashboardService, EmployeesService, MachineService, SecurityControllerService, ShiftScheduleService, SparePartService];
