...
@Schema(name = "DashboardPerformanceInditatorDTO", description = "Statystyki związane z wydajnością w kontekście awarii")
public record DashboardPerformanceInditatorDTO(
