...
class SparePartServiceTest {
    ...
    @Mock
    private BreakdownUsedPartsRepository breakdownUsedPartsRepository;
    ...
    void setUp() {
        ...
        testSparePart.setStockQuantity(6);
        responseDTO = new SparePartResponseDTO(1L, "Test Part", BigDecimal.TEN, "Producer", 12);
        createRequest = new CreateSparePartDTO("Test Part", BigDecimal.TEN, "Producer", 22);
        updateRequest = new UpdateSparePartDTO("Updated Part", BigDecimal.ONE, "New Producer");
    }

    @AfterEach
    void tearDown() {
        breakdownUsedPartsRepository.deleteAll();
